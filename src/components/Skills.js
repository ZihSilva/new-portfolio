...
export function Skills() {
  return (
    ...
    className="bg-beige dark:bg-slate-900 text-white dark:text-white z-30 mx-auto">
      ...
      <div className="container relative flex flex-col items-start justify-center flex-grow px-16 mx-auto md:px-20 lg:px-32 py-40 section">
        ...
        <hr className="bg-greendark w-28 h-1.5 mt-4 mb-6 border-0"></hr>
         ...
         {/* grid icons */}
          <ul className="grid grid-cols-3 w-50% mt-8 pr-4 gap-10 sm:grid-cols-4 md:grid-cols-6 md:pr-0 lg:w-80% lg:mt-20 lg:gap-10 ">
            <li className="flex-wrap space-around w-full text-center flex-col flex justify-start  text-white text-md">
              <img
            ...
            <li className="flex-wrap space-around w-full text-center  flex-col flex justify-center  text-white text-sm">
              <img
