        ...
        <div className="mt-8 w-full sm:mx-auto md:text-lg md:w-[35rem] mx-auto lg:max-w-xl ">
          ...
          >
            ...
            <div className="relative mt-6">
              <input
                type="email"
                className="block w-full text-slate-600 h-12 sm:h-14 px-4 text-xl sm:text-2xl font-mono outline-none border-2 border-slate-700 bg-transparent rounded-[0.6rem] transition-all duration-200 focus:bg-gray-dark-5  active:bg-gray-dark-5"
                onChange= {handleChange}
                value={email}
                name="email"
                placeholder="Email"
            ...
            <button
              type="submit"
              onSubmit={handleSubmit}
              className="text-slate-800  w-full h-12 p-1 mb-6 mt-6 border-2 bg-greendark b-6 border-midnight dark:bg-slate-400 text-lg font-bold border-md rounded-lg  focus: hover:bg-slate-400 hover:text-slate-900 cursor-pointer duration-300"
            >
              Send Message
            </button>
          </form>
